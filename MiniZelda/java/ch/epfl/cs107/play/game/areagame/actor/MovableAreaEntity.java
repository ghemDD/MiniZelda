...
//    }
     ...
     */
    public void randomMove(int animationDuration) {
    	//A number is taken between 1 and 10 : such that there is 60% of probability that it exceeds 4
    	// If so the logMonster moves else it is reoriented 
    	...
    	if (random>4) 
    		...
    		if(!(isDisplacementOccurs())) {
    			...
    			orientate(Orientation.values()[random]);
    		}
    	}
    }
}